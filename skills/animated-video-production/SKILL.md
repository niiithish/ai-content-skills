...
- Use `animated-scene-still` to compose one scene still per planned clip or materially different shot. Match the user's project aspect ratio; for an unspecified short-form vertical video, use 9:16. Preserve the reference identities, proportions, wardrobe, prop markings, location layout, and light direction.
